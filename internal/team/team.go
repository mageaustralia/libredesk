...
func (u *Manager) Create(name, timezone, conversationAssignmentType string, businessHrsID, slaPolicyID null.Int, emoji, color string, maxAutoAssignedConversations int) (models.Team, error) {
	var team models.Team
	if err := u.q.InsertTeam.Get(&team, name, timezone, conversationAssignmentType, businessHrsID, slaPolicyID, emoji, color, maxAutoAssignedConversations); err != nil {
...
func (u *Manager) Update(id int, name, timezone, conversationAssignmentType string, businessHrsID, slaPolicyID null.Int, emoji, color string, maxAutoAssignedConversations int) (models.Team, error) {
	var team models.Team
	if err := u.q.UpdateTeam.Get(&team, id, name, timezone, conversationAssignmentType, businessHrsID, slaPolicyID, emoji, color, maxAutoAssignedConversations); err != nil {
