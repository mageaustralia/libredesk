...
// Implementation is via the shared doChatCompletion helper so the
// request/response plumbing stays in one place — the only OpenAI-specific
// bits are the URL and the hardcoded gpt-4o-mini model.
