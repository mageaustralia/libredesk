...
// backend stores it against the right per-tab slot (see V2_2_20 migration).
// Empty message_type is treated as 'reply' on the server for back-compat.
