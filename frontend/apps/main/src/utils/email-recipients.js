...
export function isAutoGeneratedMessage (message) {
    ...
    // Upstream v2.3.0 tags automation/CSAT replies with is_automated — skip
    // those too so an auto-reply never drives recipient derivation.
    if (meta.is_automated) return true
