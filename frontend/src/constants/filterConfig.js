...
export const FIELD_OPERATORS = {
    SELECT: [OPERATOR.EQUALS, OPERATOR.NOT_EQUALS, OPERATOR.IN, OPERATOR.NOT_IN, OPERATOR.SET, OPERATOR.NOT_SET],
    ...
    SELECT_ASSIGNEE: [OPERATOR.EQUALS, OPERATOR.NOT_EQUALS, OPERATOR.IN, OPERATOR.NOT_IN, OPERATOR.IN_OR_NULL, OPERATOR.SET, OPERATOR.NOT_SET],
}
